...
test/build/NoisyMap: test/NoisyMap.cc src/Environment.h build/Environment.o build/NoisyMap.o test/DeterministicNoise.h
	g++ -o test/build/NoisyMap test/NoisyMap.cc build/Environment.o build/NoisyMap.o vendor/jsoncpp/lib/json_writer.o vendor/jsoncpp/lib/json_reader.o vendor/jsoncpp/lib/json_value.o
