...
test/build/EMSensor: test/EMSensor.cc src/Environment.h build/Environment.o build/EMSensor.o build/Guard.o test/ConstantNoise.h
	g++ -o test/build/EMSensor test/EMSensor.cc build/Environment.o build/EMSensor.o build/Guard.o vendor/jsoncpp/lib/json_writer.o vendor/jsoncpp/lib/json_reader.o vendor/jsoncpp/lib/json_value.o
